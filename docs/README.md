...
最新稳定版：v1.5.6+36
最新测试版：v1.5.7+37 - 滚动更新

## 软件下载

 - [安卓版本下载（提供商：F-Droid 清华镜像站）](https://mirrors.tuna.tsinghua.edu.cn/fdroid/repo/io.github.benderblog.traintime_pda_363.apk)
...
14. 查询考勤记录。
15. Android 日程查看桌面小部件。
16. 完备的国际化支持：支持繁体中文和英语。
17. 上课前提醒。
...
## 其他相关链接
 ...
 - [Apple Watch 版本技术说明](apple_watch_technical_overview.md)
