                ...
                if let current = switchableCurrentCourse {
                    Button(
                        ...
                        Image(systemName: schedule.isPreview ? "arrow.uturn.backward" : "arrow.right")
                            ...
                            // 扩大实际按钮边界，图标保持原位，不改变卡片文字布局。
                            .frame(width: 56, height: 44, alignment: .topTrailing)
