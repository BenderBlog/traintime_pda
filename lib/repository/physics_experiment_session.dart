...
enum PhysicsExperimentCacheHint implements CacheHint {
  ...
  String resolve(Translations tr) => switch (this) {
    missingPassword  => tr.experiment.physicsCacheHintMissingPassword,
    loginFailed      => tr.experiment.physicsCacheHintLoginFailed,
    notSchoolNetwork => tr.experiment.physicsCacheHintNotSchoolNetwork,
    networkFailed    => tr.experiment.physicsCacheHintNetworkFailed,
    unknownError     => tr.experiment.physicsCacheHintUnknownError,
  };
}
