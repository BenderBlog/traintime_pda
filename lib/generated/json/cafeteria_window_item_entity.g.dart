...
CafeteriaWindowItemEntity $CafeteriaWindowItemEntityFromJson(Map<String, dynamic> json) {
	final CafeteriaWindowItemEntity cafeteriaWindowItemEntity = CafeteriaWindowItemEntity();
	final List<CafeteriaWindowItemResults>? results = jsonConvert.convertListNotNull<CafeteriaWindowItemResults>(json['results']);
	if (results != null) {
...
Map<String, dynamic> $CafeteriaWindowItemEntityToJson(CafeteriaWindowItemEntity entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['results'] =  entity.results.map((v) => v.toJson()).toList();
	return data;
}

CafeteriaWindowItemResults $CafeteriaWindowItemResultsFromJson(Map<String, dynamic> json) {
	final CafeteriaWindowItemResults cafeteriaWindowItemResults = CafeteriaWindowItemResults();
...
Map<String, dynamic> $CafeteriaWindowItemResultsToJson(CafeteriaWindowItemResults entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
