...
ShopInformationEntity $ShopInformationEntityFromJson(Map<String, dynamic> json) {
	final ShopInformationEntity shopInformationEntity = ShopInformationEntity();
	final List<ShopInformationResults>? results = jsonConvert.convertListNotNull<ShopInformationResults>(json['results']);
	if (results != null) {
...
Map<String, dynamic> $ShopInformationEntityToJson(ShopInformationEntity entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['results'] =  entity.results.map((v) => v.toJson()).toList();
	return data;
}

ShopInformationResults $ShopInformationResultsFromJson(Map<String, dynamic> json) {
	final ShopInformationResults shopInformationResults = ShopInformationResults();
...
Map<String, dynamic> $ShopInformationResultsToJson(ShopInformationResults entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
