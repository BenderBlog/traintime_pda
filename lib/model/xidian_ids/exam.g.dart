...
ToBeArranged _$ToBeArrangedFromJson(Map<String, dynamic> json) =>
    ToBeArranged(subject: json['subject'] as String, id: json['id'] as String);

Map<String, dynamic> _$ToBeArrangedToJson(ToBeArranged instance) =>
    <String, dynamic>{'subject': instance.subject, 'id': instance.id};
