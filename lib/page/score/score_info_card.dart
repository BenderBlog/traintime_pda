      ...
      child: AnimatedOpacity(
        ...
        child: ReXCard(
          ...
          bottomRow: DefaultTextStyle(
            ...
            child: [
              Text(
                "${context.t.score.scoreComposeCard.credit}: ${c.scoreData[widget.mark].credit}",
              ).expanded(flex: 2),
              Text(
                "${context.t.score.scoreComposeCard.gpa}: ${c.scoreData[widget.mark].gpa}",
              ).expanded(flex: 3),
              Text(
                "${context.t.score.scoreComposeCard.score}: ${c.scoreData[widget.mark].scoreStr}",
              ).expanded(flex: 3),
            ].toRow(),
          ),
        ),
