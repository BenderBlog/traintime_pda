  ...
  Widget scoreInfo(bool isInClass, BuildContext context) => Card(
        ...
        child: GetBuilder<ScoreController>(
          builder: (c) => FutureBuilder<ScorePlace>(
            future: isInClass
                ? c.getPlaceInClass(score.classID, score.year)
                : c.getPlaceInGrade(score.courseID, score.year),
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                        ...
                        TableRow(
                          children: <Widget>[
                            ...
                            TableCell(
                              child: Align(
                                alignment: Alignment.centerRight,
                                child: Text(snapshot.data!.highest.toString()),
                              ),
                            ),
                          ],
                        ),
                        TableRow(
                          children: <Widget>[
                            ...
                            TableCell(
                              child: Align(
                                alignment: Alignment.centerRight,
                                child: Text(snapshot.data!.lowest.toString()),
                              ),
                            ),
                          ],
                        ),
                        TableRow(
                          children: <Widget>[
                            ...
                            TableCell(
                              child: Align(
                                alignment: Alignment.centerRight,
                                child: Text(snapshot.data!.average.toString()),
                              ),
                            ),
                          ],
                        ),
                ...
                info.add(
                    const InfoDetailBox(child: Center(child: Text("正在获取"))));
              }
              return Container(
