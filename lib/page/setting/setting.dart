...
import 'package:watermeter/page/setting/captcha_input_dialog.dart';
                      ...
                      onTap: () async {
                        if (preference
                          ...
                          await showDialog(
                            context: context,
                            builder: (context) =>
                                const SchoolNetPasswordDialog(),
                          );
                        }
                        await SchoolnetSession()
                            .getNetworkUsage(
                              captcha: (memoryImage) => showDialog<String?>(
                                context: context,
                                builder: (context) =>
                            ...
                            .onError<ConnectionException>((e, __) =>
