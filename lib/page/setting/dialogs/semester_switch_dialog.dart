...
class _SemesterSwitchDialogState extends State<SemesterSwitchDialog> {
    ...
    yearOptions = years
        .map(
          (e) => WheelChooseOptions(
            data: e,
            hint: I18n.of(context)!.classtableSemesterSwitcherYear('$e'),
          ),
        )
        .toList();
    semesterOptions = [
      WheelChooseOptions(
        data: 1,
        hint: I18n.of(context)!.classtableSemesterSwitcherFirstAcademicYear,
      ),
      WheelChooseOptions(
        data: 2,
        hint: I18n.of(context)!.classtableSemesterSwitcherSecondAcademicYear,
      ),
    ];
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(I18n.of(context)!.classtableSemesterSwitcherChooseSemester),
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Text(
              I18n.of(context)!.classtableSemesterSwitcherOnlyFutureHint,
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: Text(
                  _isFetching
                      ? I18n.of(context)!.classtableSemesterSwitcherFetchingRemoteSemester
                      : I18n.of(context)!.classtableSemesterSwitcherFetchRemoteSemester,
                ),
              ),
            ),
          ],
