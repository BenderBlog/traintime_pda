...
class _AirconImeiDialogState extends State<AirconImeiDialog> {
  ...
  Future<void> _scanQrCode() async {
    if (!_canUseCameraScanner) {
      showToast(
        context: context,
        msg: I18n.of(context)!.settingAirconCameraUnavailable,
      );
      return;
    }
  ...
  Future<void> _pickQrCodeImage() async {
    try {
      ...
      if (imei == null) {
        showToast(
          context: context,
          msg: I18n.of(context)!.settingAirconImeiInvalid,
        );
        return;
      }
  ...
  Future<void> _save() async {
    try {
      ...
      showToast(
        context: context,
        msg: I18n.of(context)!.settingAirconImeiSaved,
      );
  ...
  Future<void> _clear() async {
    ...
    showToast(
      context: context,
      msg: I18n.of(context)!.settingAirconImeiCleared,
    );
    Navigator.pop(context);
  }
    ...
    return AlertDialog(
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              labelText: I18n.of(context)!.settingAirconImei,
            ),
          ),
              ...
              children: [
                if (_canUseCameraScanner)
                  TextButton.icon(
                    ...
                    label: Text(
                      I18n.of(context)!.settingScanAirconQr,
                    ),
                  ),
                TextButton.icon(
                  ...
                  label: Text(
                    I18n.of(context)!.settingPickAirconQrImage,
                  ),
                ),
              ],
            ),
      ...
      actions: [
        TextButton(
          onPressed: _clear,
          child: Text(
            I18n.of(context)!.settingAirconImeiClear,
          ),
        ),
        TextButton(
...
class _AirconImeiScannerPageState extends State<_AirconImeiScannerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(I18n.of(context)!.settingScanAirconQr),
      ),
      body: ReaderWidget(
        isMultiScan: true,
