...
class _LoginWindowState extends State<LoginWindow> {
    ...
    children: [
      TextField(
        ...
        decoration: _inputDecoration(
          ...
          hintText: I18n.of(context)!.loginIdentityNumber,
        ),
      ).center(),
      ...
      FilledButton(
        ...
        onPressed: () async {
          if (_idsPasswordController.text.isNotEmpty) {
            ...
            showToast(
              context: context,
              msg: I18n.of(context)!.loginIncorrectPasswordPattern,
            );
          }
        },
      ),
  ...
  Future<void> login() async {
    ...
    pd.show(
      msg: I18n.of(context)!.loginOnLoginProgress,
      max: 100,
      hideValue: true,
      completed: Completed(
        completedMsg: I18n.of(context)!.loginCompleteLogin,
      ),
    );
        ...
        onResponse: (int number, LoginProcessStep status) => pd.update(
          msg: switch (status) {
            LoginProcessStep.readyPage =>
              I18n.of(context)!.loginProcessReadyPage,
            LoginProcessStep.getEncrypt =>
              I18n.of(context)!.loginProcessGetEncrypt,
            LoginProcessStep.readyLogin =>
              I18n.of(context)!.loginProcessReadyLogin,
            LoginProcessStep.slider =>
              I18n.of(context)!.loginProcessSlider,
            LoginProcessStep.afterProcess =>
              I18n.of(context)!.loginProcessAfterProcess,
          },
          value: number,
        ),
        ...
        if (e is PasswordWrongException) {
          ...
          if (e.message == null) {
            if (e.response == null) {
              showToast(
                context: context,
                msg: I18n.of(context)!.loginFailedLoginCannotConnectToServer,
              );
            } else {
              showToast(
                context: context,
                msg: I18n.of(context)!.loginFailedLoginWithCode(e.response!.statusCode.toString()),
              );
            }
          } else {
            showToast(
              context: context,
              msg: I18n.of(context)!.loginFailedLoginWithMessage(e.message.toString()),
            );
          }
        } else {
          log.warning(
          ...
          showToast(
            context: context,
            msg: I18n.of(context)!.loginFailedLoginOther,
          );
        }
      }
    }
