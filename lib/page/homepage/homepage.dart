      ...
      builder: (context) {
        ...
        if (hidden.isEmpty) {
          return Padding(
            ...
            child: Text(
              I18n.of(context)!.homepageHideEmpty,
        ...
        return ListView(
          ...
          children: [
            Padding(
              ...
              child: Text(
                I18n.of(context)!.homepageHiddenTitle,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (_editMode) ...[
            IconButton(
              icon: const Icon(Icons.visibility),
              tooltip: I18n.of(context)!.homepageManageHidden,
              onPressed: _showHiddenSheet,
            ),
            IconButton(
              icon: const Icon(Icons.restore),
              tooltip: I18n.of(context)!.homepageEditReset,
              onPressed: () async {
                await resetAll();
                setState(() => _allEntries = getOrderedEntries());
              },
          ...
          Padding(
            ...
            child: IconButton(
              ...
              tooltip: _editMode ? I18n.of(context)!.homepageEditDone : I18n.of(context)!.homepageEditMode,
              onPressed: () {
                if (_editMode) {
                  _exitEditMode();
                } else {
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          showToast(
            context: context,
            msg: I18n.of(context)!.homepageLoadingMessage,
          );
          await update(
            context: context,
          ...
          if (context.mounted) {
            showToast(
              context: context,
              msg: I18n.of(context)!.homepageLoaded,
            );
          }
        },
        child: ListView(
          ...
          children: [
            ...
            if (_editMode)
              Padding(
                ...
                child: Text(
                  I18n.of(context)!.homepageEditHint,
                  style: TextStyle(
