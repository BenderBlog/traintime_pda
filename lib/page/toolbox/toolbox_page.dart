...
class _ToolBoxPageState extends State<ToolBoxPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(context.t.toolbox.title)),
      body: ListView(
        children: [
          WebViewAddresses(
            name: context.t.toolbox.payment,
            url:
            ...
            description: context.t.toolbox.paymentDescription,
            iconData: MingCuteIcons.mgc_exchange_cny_line,
          ),
          WebViewAddresses(
            name: context.t.toolbox.drinkingwater,
            url: "https://order.xidian.edu.cn/mobile/thirdoauth/oauth2Xidian/1",
            description: context.t.toolbox.drinkingwaterDescription,
            iconData: MingCuteIcons.mgc_drop_line,
          ),
          WebViewAddresses(
            name: context.t.toolbox.repair,
            url:
            ...
            description: context.t.toolbox.repairDescription,
            iconData: MingCuteIcons.mgc_tool_line,
          ),
          WebViewAddresses(
            name: context.t.toolbox.reserve,
            url: "http://libspace.xidian.edu.cn",
            description: context.t.toolbox.reserveDescription,
            iconData: MingCuteIcons.mgc_building_4_line,
          ),
          WebViewAddresses(
            name: context.t.toolbox.network,
            url: "https://zfw.xidian.edu.cn",
            description: context.t.toolbox.networkDescription,
            iconData: MingCuteIcons.mgc_wifi_line,
          ),
          WebViewAddresses(
            name: context.t.toolbox.physics,
            url: "https://experiment-helper.wizzstudio.com/#/",
            description: context.t.toolbox.physicsDescription,
            iconData: MingCuteIcons.mgc_counter_2_line,
          ),
          WebViewAddresses(
            name: context.t.toolbox.discover,
            url: "https://nav.xdruisi.cn/",
            description: context.t.toolbox.discoverDescription,
