...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(I18n.of(context)!.ruisiLoginTitle),
      ),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: I18n.of(context)!.ruisiLoginUsername,
                  prefixIcon: const Icon(Icons.person),
                  border: const OutlineInputBorder(),
                ),
                validator: (v) => (v == null || v.isEmpty)
                    ? I18n.of(context)!.ruisiLoginUsernameHint
                    : null,
              ),
              ...
              TextFormField(
                ...
                obscureText: true,
                decoration: InputDecoration(
                  labelText: I18n.of(context)!.ruisiLoginPassword,
                  prefixIcon: const Icon(Icons.lock),
                  border: const OutlineInputBorder(),
                ),
                validator: (v) => (v == null || v.isEmpty)
                    ? I18n.of(context)!.ruisiLoginPasswordHint
                    : null,
              ),
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: I18n.of(context)!.ruisiLoginCaptcha,
                            prefixIcon: const Icon(Icons.security),
                            border: const OutlineInputBorder(),
                          ),
                          validator: (v) =>
                              _captchaRequired && (v == null || v.isEmpty)
                              ? I18n.of(context)!.ruisiLoginCaptchaHint
                              : null,
                        ),
                      ),
                ...
                builder: (context, loading, _) {
                  return FilledButton(
                    ...
                    child: loading
                        ...
                        : Text(
                            I18n.of(context)!.ruisiCommonLogin,
                          ),
                  );
                },
              ),
              ...
              OutlinedButton.icon(
                ...
                label: Text(
                  I18n.of(context)!.ruisiLoginResetLoginState,
                ),
              ),
              ...
              OutlinedButton.icon(
                ...
                label: Text(
                  I18n.of(context)!.ruisiLoginViewLogs,
                ),
              ),
            ],
          ),
  ...
  Future<void> _handleResetLoginState(BuildContext context) async {
    ...
    if (context.mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            I18n.of(context)!.ruisiLoginResetSuccess,
          ),
        ),
      );
    }
